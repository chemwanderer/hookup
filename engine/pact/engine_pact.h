...
namespace engine::pact {
	...
	namespace parameter {
		...
		static constexpr QStringView __unitsKey__ =		u"Units";
		static constexpr QStringView __quantityNameKey__ =	u"Quantity Name";
	...
	namespace routine {
		...
		namespace inner {
			...
			namespace kin {
				static constexpr QStringView __type__ =			u"Kinetics";

				static constexpr QStringView __period__ =		u"Period (ms)";
				static constexpr QStringView __currentADCValueID__ =	u"Current ADC Value ID";
				static constexpr QStringView __fullTransmittanceADCValueID__ = 	u"Full Transmittance ADC Value ID";
				static constexpr QStringView __transmittanceID__ =	u"Transmittance ID";
				static constexpr QStringView __recordTimeID__ =		u"Record Time ID";
			}
		}
	}
}
